...
.config(function ($stateProvider, $urlRouterProvider, $httpProvider, $sceDelegateProvider) {
	...
	.state('app.performer1', {
		url: "/performer1",
		views: {
			'menuContent': {
				templateUrl: "templates/performer1.html",
				controller: 'ProgramCtrl'
			}
		}
	})	
	.state('app.performer2', {
		url: "/performer2",
		views: {
			'menuContent': {
				templateUrl: "templates/performer2.html",
				controller: 'ProgramCtrl'
			}
		}
	})	
	.state('app.performer3', {
		url: "/performer3",
		views: {
			'menuContent': {
				templateUrl: "templates/performer3.html",
				controller: 'ProgramCtrl'
			}
		}
	})	
